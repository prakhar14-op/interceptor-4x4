"""
TEST NEW AV MODEL ON 100 VIDEOS
Test the new AV specialist model (trained with our scripts)
"""
...
class AudioVisualModule(nn.Module):
    ...
    def __init__(self, in_channels=3):
        ...
        self.attention = nn.Sequential(
            nn.Conv2d(12 + 12 + 12 + 12, 32, kernel_size=1), nn.ReLU(),
...
class AVSpecialistModel(nn.Module):
    ...
    def __init__(self, num_classes=2):
        ...
        total_features = 1792 + (48 * 7 * 7)  # 1792 + 2352 = 4144
...
# MODEL TESTING
# ============================================================================
def test_new_av_model():
    """Test new AV model on 100 videos"""
    
    print("🚀 TESTING NEW AV MODEL")
    print("="*60)
    
    # Apply numpy fix
    fix_numpy_compatibility()
    
    # Try to find AV model checkpoint
    possible_paths = [
    ...
    if model_path is None:
        print(f"❌ No AV model checkpoint found")
        print(f"   Tried: {possible_paths}")
        print(f"   Please provide the AV model checkpoint file")
        return
    ...
    # Create model
    print(f"\n🔄 Creating AV model architecture...")
    ...
    results = {
        'model_info': {
            ...
            'architecture': 'AV Specialist (EfficientNet-B4 + Audio-Visual Module)'
        },
        'test_results': {
    ...
    with open('new_av_model_test_results.json', 'w') as f:
        json.dump(results, f, indent=2)
    
    print(f"\n✅ Results saved to: new_av_model_test_results.json")
