"""
REINSTALL BG AND AV MODELS
Delete corrupted models and re-download from Hugging Face
"""
...
def delete_old_models():
    """Delete old/corrupted BG and AV models"""
    
    print("🗑️  DELETING OLD/CORRUPTED MODELS")
    print("="*60)
