"""
BACKGROUND/LIGHTING (BG) MODEL - STAGE 2: CELEB-DF TRAINING
...
STAGE1_CHECKPOINT = '/kaggle/input/bg-stage1-model/bg_stage1_final.pt'  # UPDATE THIS PATH
...
print(f"🚀 BG MODEL - STAGE 2: CELEB-DF TRAINING")
...
def main():
    ...
    print("\n🚀 STARTING BG MODEL STAGE 2 TRAINING")
    print("="*80)
