"""
DOWNLOAD ALL CHECKPOINTS FROM OUTPUT
Find all checkpoint files (.pt and .zip) and create a single zip for download
"""
...
def find_and_zip_all_checkpoints():
    """Find all checkpoint files and create a single zip"""
    
    print("🔍 FINDING ALL CHECKPOINT FILES")
    print("="*60)
    ...
    # Find all checkpoint files (.pt and .zip)
    all_checkpoints = []
