"""
TEMPORAL (TM) MODEL - STAGE 4: DFDC TRAINING
...
OUTPUT: Final TM specialist model
"""
...
STAGE2_CHECKPOINT = '/kaggle/input/tm-stage2-model/tm_stage2_final.pt'  # UPDATE THIS PATH
...
print(f"🚀 TM MODEL - STAGE 4: DFDC TRAINING")
...
def main():
    ...
    print("\n🚀 STARTING TM MODEL STAGE 4 TRAINING")
    print("="*80)
    ...
    for chunk_idx in CHUNKS_TO_TRAIN:
        ...
        for epoch in range(1, EPOCHS_PER_CHUNK + 1):
            ...
            if train_metrics['accuracy'] > best_accuracy:
                ...
                checkpoint_manager.save_checkpoint(
                    model_state,
                    f"tm_stage4_chunk{chunk_idx}_epoch{epoch}",
                    train_metrics
                )
        ...
        checkpoint_manager.save_checkpoint(
            model_state,
            f"tm_stage4_chunk{chunk_idx}_complete",
            eval_metrics
        )
    ...
    print(f"\n✅ TM Specialist Model Training Complete!")
