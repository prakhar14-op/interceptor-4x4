"""
TEMPORAL (TM) MODEL - STAGE 2: CELEB-DF TRAINING
...
STAGE1_CHECKPOINT = '/kaggle/input/tm-stage1-model/tm_stage1_final.pt'  # UPDATE THIS PATH
...
print(f"🚀 TM MODEL - STAGE 2: CELEB-DF TRAINING")
...
def main():
    ...
    print("\n🚀 STARTING TM MODEL STAGE 2 TRAINING")
    print("="*80)
