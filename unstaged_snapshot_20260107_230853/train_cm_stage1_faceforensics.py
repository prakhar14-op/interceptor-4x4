"""
COMPRESSION (CM) MODEL - STAGE 1: FACEFORENSICS++ TRAINING
...
print(f"🚀 CM MODEL - STAGE 1: FACEFORENSICS++ TRAINING")
...
def main():
    ...
    print("\n🚀 STARTING CM MODEL STAGE 1 TRAINING")
    print("="*80)
